            ...
            <div class="col">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <h4 class="card-title">Réfrigérateur</h4>
                        <p class="card-text">Zones de refroidissement personnalisables pour répondre à vos besoins spécifiques</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <h4 class="card-title">Lave-linge</h4>
                        <p class="card-text">Programmes de lavages et de séchage et d'options économes en énergie&nbsp;</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <h4 class="card-title">Machine à café</h4>
                        <p class="card-text">Offre une préparation de café avec des réglages de mouture</p>
                    </div>
                </div>
            </div>
        </div>
